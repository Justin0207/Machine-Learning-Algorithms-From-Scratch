...
class DeepNeuralNetwork:
    def __init__(self, sizes, activation='relu', optimizer='momentum', epochs=1000, batch_size=32, lr=0.0001, beta=0.9):
        self.sizes = sizes
        self.epochs = epochs
    ...
    def initialize(self):
        ...
        params = {
            ...
            'W2': np.random.randn(output_layer, hidden_layer) * np.sqrt(1./input_layer),
...
lr = DeepNeuralNetwork(sizes = [x_train.shape[1], 8, 1])
